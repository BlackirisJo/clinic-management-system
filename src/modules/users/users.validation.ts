...
export const createUserSchema = z.object({
  ...
  role_name: z.enum(['DOCTOR', 'ACCOUNTANT', 'RECEPTIONIST', 'NURSE', 'SYSTEM_ADMIN', 'SUPER_ADMIN']),
...
export const updateUserSchema = z.object({
  ...
  role_name: z.enum(['DOCTOR', 'ACCOUNTANT', 'RECEPTIONIST', 'NURSE', 'SYSTEM_ADMIN', 'SUPER_ADMIN']).optional(),
  clinic_id: z.coerce.number().int().positive().nullable().optional(),
  phone: z.string().max(20).optional(),
