...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  DOCTOR: ['VIEW_PATIENTS', 'EDIT_PATIENT_MEDICAL', 'CREATE_VISIT', 'VIEW_APPOINTMENTS', 'MANAGE_APPOINTMENTS', 'CREATE_PRESCRIPTION', 'VIEW_PRESCRIPTIONS', 'VIEW_MEDICATIONS', 'MANAGE_PREGNANCY', 'VIEW_SHARED_PATIENT_RECORDS'],
